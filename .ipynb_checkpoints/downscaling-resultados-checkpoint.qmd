...
<div style="max-width:960px;margin:6rem auto;padding:0 1.5rem;">
 ...
 <div class="ds-header-card">
  ...
  <p style="font-size:0.9rem;color:#4a5568;margin-bottom:1.5rem;">
    Vistas conjuntas que sintetizan el comportamiento de los ocho modelos para el periodo de predicción.
  </p>

  <div class="ds-gallery">

    <figure class="ds-gallery-item">
      <img src="images/downscaling/3_terciles_ALLMODELS_DOWNS_pr_3m.png"
           alt="Terciles · Todos los modelos · Downscaling"
           class="ds-gallery-img"
           data-caption="Probabilidad por terciles · Todos los modelos · Downscaling" />
      <figcaption>
        <strong>Probabilidad por terciles — Todos los modelos</strong>
        <span>Salidas individuales del downscaling para los 8 modelos en una sola figura.</span>
        <a href="images/downscaling/3_terciles_ALLMODELS_DOWNS_pr_3m.png"
           download class="ds-gallery-dl">↓ Descargar</a>
      </figcaption>
    </figure>

    <figure class="ds-gallery-item">
      <img src="images/downscaling/8-combination_DOWN_pr_3m.png"
           alt="Combinación de modelos · Downscaling"
           class="ds-gallery-img"
           data-caption="Combinación multimodelo · Downscaling" />
      <figcaption>
        <strong>Combinación multimodelo</strong>
        <span>Resultado agregado de los modelos del downscaling.</span>
        <a href="images/downscaling/8-combination_DOWN_pr_3m.png"
           download class="ds-gallery-dl">↓ Descargar</a>
      </figcaption>
    </figure>
