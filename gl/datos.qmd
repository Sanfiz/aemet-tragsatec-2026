...
<div style="max-width:1100px;margin:6rem auto;padding:0 1.5rem;">
  ...
  <section id="copernicus" class="datos-section">
    ...
    <ul class="datos-vars">
      <li>
        <h5>Presión al nivel del mar</h5>
      ...
      <li>
        <h5>Altura geopotencial 500 hPa</h5>
        <p>Componentes del viento a 500 hPa (u500, v500). Empleada en la
        caracterización de la circulación Euro-Atlántica.</p>
      </li>
      <li>
        <h5>Temperatura a 2 m</h5>
        <p>Variable predictanda usada en downscaling y weighting.</p>
      </li>
      <li>
        <h5>Precipitación total</h5>
