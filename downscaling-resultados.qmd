...
<div style="max-width:960px;margin:6rem auto;padding:0 1.5rem;">
 ...
 <div class="ds-header-card">
  ...
  <div class="ds-header-block">
    ...
    <span class="ds-header-value" id="ds-init-display">Predicción Trimestral</span>
  </div>
</div>
  ...
  <div class="ds-gallery">
    ...
    <figure class="ds-gallery-item">
      ...
      <figcaption>
        ...
        <span>ROC AUC tercil seco (columna izquierda), probabilidad tercil seco y tercil húmedo (centro), 
        ROC AUC tercil húmedo (columna derecha).</span>
...
/* La clase primary queda como alias del estilo base */
.ds-action-primary {
  background: white;
  color: #003087;
  border-color: #dde3ed;
...
const GRAPHS = [
  { id: 'terciles', label: 'Probabilidad por terciles', prefix: '3_terciles_pr_',      caption: 'Probabilidad por terciles' },
  { id: 'corr',     label: 'Correlación de Spearman',   prefix: '4_corr-spearman_pr_', caption: 'Correlación de Spearman' },
...
document.getElementById('ds-init-display').textContent   = 'Predicción Trimestral';
